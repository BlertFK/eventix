...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        className="absolute top-1/4 -left-32 w-96 h-96 rounded-full bg-purple/20 blur-[120px]"
        style={{ animation: "float 15s ease-in-out infinite" }}
      />
      <div
        className="absolute bottom-1/4 -right-32 w-96 h-96 rounded-full bg-pink/20 blur-[120px]"
        style={{ animation: "float 18s ease-in-out infinite reverse" }}
      />
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-cyan/10 blur-[150px]"
